...
install_resource "Artsy+UIFonts/Pod/Assets/ITC_Avant_Garde_Gothic__Demi.ttf"
install_resource "../../Pod/Assets/Chevron_Gray.png"
install_resource "../../Pod/Assets/Chevron_Gray@2x.png"
